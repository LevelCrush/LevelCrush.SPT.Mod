...
export class LevelCrushQuestController extends QuestController {
    constructor(
        ...
        super(logger, timeUtil, httpResponseUtil, eventOutputHolder, databaseService, itemHelper, dialogueHelper, mailSendService, profileHelper, traderHelper, questHelper, questConditionHelper, playerService, localeService, localisationService, configServer, cloner);
    }
