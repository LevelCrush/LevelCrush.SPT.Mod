...
export declare class InraidController {
   ...
   */
  protected savePmcProgress(
    sessionID: string,
    postRaidRequest: ISaveProgressRequestData
  ): void;
  /**
   ...
   */
  protected updatePmcHealthPostRaid(
    postRaidSaveRequest: ISaveProgressRequestData,
    pmcData: IPmcData
  ): void;
  /**
   ...
   */
  protected reducePmcHealthToPercent(
    pmcData: IPmcData,
    multiplier: number
  ): void;
  /**
   ...
   */
  protected savePlayerScavProgress(
    sessionID: string,
    postRaidRequest: ISaveProgressRequestData
  ): void;
  /**
   ...
   */
  protected mergePmcAndScavEncyclopedias(
    primary: IPmcData,
    secondary: IPmcData
  ): void;
  /**
   ...
   */
  protected migrateScavQuestProgressToPmcProfile(
   ...
   */
  protected markOrRemoveFoundInRaidItems(
    offraidData: ISaveProgressRequestData
  ): void;
  /**
