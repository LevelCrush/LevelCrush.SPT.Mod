...
export declare class MatchController {
   ...
   */
  startOfflineRaid(
    request: IGetRaidConfigurationRequestData,
    sessionID: string
  ): void;
  /**
   ...
   */
  protected convertDifficultyDropdownIntoBotDifficulty(
   ...
   */
  protected getFenceStandingAfterExtract(
    pmcData: IPmcData,
    baseGain: number,
    extractCount: number
  ): number;
