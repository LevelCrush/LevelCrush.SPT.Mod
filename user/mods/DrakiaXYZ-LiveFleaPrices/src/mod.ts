...
import * as LCQolNoRestrictions from '../../LevelCrush-QOL-NoRestrictions/src/mod';
...
class Mod implements IPostDBLoadModAsync {
    ...
    static async updatePrices(fetchPrices = true): Promise<boolean> {
         ...
         * LevelCrush patch
         */
        logger.info('LC Custom Patch: Ammo Flea Market');

        LCQolNoRestrictions.ammo_flea_market(logger, databaseServer.getTables());
