...
export declare class HideoutHelper {
   ...
   */
  protected doesProgressMatchProductionTime(
    pmcData: IPmcData,
    prodId: string
  ): boolean;
  /**
   ...
   */
  protected updateScavCaseProductionTimer(
    pmcData: IPmcData,
    productionId: string
  ): void;
  /**
   ...
   */
  protected addBtcToProduction(
    btcProd: Production,
    coinCraftTimeSeconds: number
  ): void;
  /**
   ...
   */
  protected getSkillBonusMultipliedBySkillLevel(
    pmcData: IPmcData,
    skill: SkillTypes,
   ...
   */
  protected hideoutImprovementIsComplete(
    improvement: IHideoutImprovement
  ): boolean;
  /**
   ...
   */
  protected getDogtagCombatSkillBonusPercent(
    pmcData: IPmcData,
    activeDogtags: Item[]
  ): number;
}
