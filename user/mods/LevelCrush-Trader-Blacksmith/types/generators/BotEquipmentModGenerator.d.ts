...
} from "@spt-aki/services/BotWeaponModLimitService";
...
export declare class BotEquipmentModGenerator {
  ...
  protected modSlotCanHoldMuzzleDevices(
    modSlot: string,
    modsParentId: string
  ): boolean;
   ...
   * @returns Slot item
   */
  protected getModItemSlotFromDb(
    modSlot: string,
    parentTemplate: ITemplateItem
  ): Slot;
  /**
   ...
   * @returns
   */
  protected getMatchingPreset(
    weaponTemplate: ITemplateItem,
    parentItemTpl: string
  ): IPreset;
  /**
   ...
   */
  protected weaponModComboIsIncompatible(
    weapon: Item[],
    modTpl: string
  ): boolean;
  /**
   ...
   */
  protected mergeCamoraPoolsTogether(
    camorasWithShells: Record<string, string[]>
  ): string[];
  /**
