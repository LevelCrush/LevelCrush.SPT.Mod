...
import {
  IRagfairOffer,
  OfferRequirement,
} from "@spt-aki/models/eft/ragfair/IRagfairOffer";
import {
  Dynamic,
...
export declare class RagfairOfferGenerator {
   ...
   */
  protected convertOfferRequirementsIntoRoubles(
   ...
   */
  protected calculateRoublePrice(
   ...
   */
  protected createOffersFromAssort(
   ...
   * @returns Item array
   */
  protected createSingleOfferForItem(
   ...
   */
  protected randomiseOfferItemUpdProperties(
    userID: string,
    itemWithMods: Item[],
