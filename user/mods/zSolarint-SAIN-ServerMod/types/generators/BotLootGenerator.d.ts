...
export declare class BotLootGenerator {
   ...
   */
  protected getAvailableContainersBotCanStoreItemsIn(
    botInventory: PmcInventory
  ): EquipmentSlots[];
  /**
   ...
   */
  protected addForcedMedicalItemsToPmcSecure(
    botInventory: PmcInventory,
    botRole: string
  ): void;
  /**
   ...
   */
  protected getRandomItemFromPoolByRole(
    pool: ITemplateItem[],
    botRole: string
  ): ITemplateItem;
  /**
   ...
   */
  protected randomiseMoneyStackSize(
    isPmc: boolean,
    itemTemplate: ITemplateItem,
    moneyItem: Item
  ): void;
   ...
   */
  protected randomiseAmmoStackSize(
    isPmc: boolean,
    itemTemplate: ITemplateItem,
    ammoItem: Item
  ): void;
   ...
   */
  protected getItemSpawnLimitsForBotType(
    isPmc: boolean,
    botRole: string
