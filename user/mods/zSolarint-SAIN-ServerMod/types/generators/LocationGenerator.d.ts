...
import {
  ...
  SpawnpointTemplate,
  SpawnpointsForced,
} from "@spt-aki/models/eft/common/ILooseLoot";
...
export declare class LocationGenerator {
   ...
   */
  protected getRandomisableContainersOnMap(
   ...
   * @returns IStaticContainerData array
   */
  protected getGuaranteedContainers(
   ...
   */
  protected getContainersByProbabilty(
    groupId: string,
    containerData: IContainerGroupCount
  ): string[];
  /**
  ...
  protected getGroupIdToContainerMappings(
    staticContainerGroupData:
      | IStaticContainer
      | Record<string, IContainerMinMax>,
    staticContainersOnMap: IStaticContainerData[]
   ...
   */
  protected reparentItemAndChildren(
