...
import {
  IPlayerScavConfig,
  KarmaLevel,
} from "@spt-aki/models/spt/config/IPlayerScavConfig";
...
export declare class PlayerScavGenerator {
   ...
   */
  protected adjustBotTemplateWithKarmaSpecificSettings(
    karmaSettings: KarmaLevel,
   ...
   * @returns
   */
  protected setScavCooldownTimer(
    scavData: IPmcData,
    pmcData: IPmcData
  ): IPmcData;
}
