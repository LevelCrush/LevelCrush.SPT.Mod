...
export declare class DialogueController {
   ...
   */
  protected getUnreadMessagesWithAttachmentsCount(
    sessionID: string,
    dialogueID: string
  ): number;
  /**
   ...
   */
  protected handleChatWithSPTFriend(
    sessionId: string,
   ...
   */
  protected getActiveMessagesFromDialog(
    sessionId: string,
    dialogueId: string
  ): Message[];
  /**
   ...
   * @param dialogueId Dialog id
   */
  protected removeExpiredItemsFromMessage(
    sessionId: string,
    dialogueId: string
  ): void;
  /**
