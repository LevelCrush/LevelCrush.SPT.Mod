...
import {
  IPmcData,
  IPostRaidPmcData,
} from "@spt-aki/models/eft/common/IPmcData";
import {
  IQuestStatus,
  TraderInfo,
  Victim,
...
export declare class InRaidHelper {
   ...
   */
  calculateFenceStandingChangeFromKills(
    existingFenceStanding: number,
    victims: Victim[]
  ): number;
  /**
  ...
  protected validateBackendCounters(
    saveProgressRequest: ISaveProgressRequestData,
    profileData: IPmcData
  ): void;
  /**
   ...
   */
  removeSpawnedInSessionPropertyFromItems(
    postRaidProfile: IPostRaidPmcData
  ): IPostRaidPmcData;
  /**
