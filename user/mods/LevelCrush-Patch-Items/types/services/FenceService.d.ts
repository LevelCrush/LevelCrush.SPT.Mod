...
export declare class FenceService {
   ...
   */
  protected mergeAssorts(
    firstAssort: ITraderAssort,
    secondAssort: ITraderAssort
  ): ITraderAssort;
  /**
   ...
   */
  protected deleteRandomAssorts(
    itemCountToReplace: number,
    assort: ITraderAssort
  ): void;
  /**
   ...
   */
  protected removeRandomItemFromAssorts(
    assort: ITraderAssort,
    rootItems: Item[]
  ): void;
  /**
   ...
   */
  protected createAssorts(
    itemCounts: IGenerationAssortValues,
   ...
   */
  protected itemShouldBeForceStacked(
    existingItem: Item,
    itemDbDetails: ITemplateItem
  ): boolean;
  /**
   ...
   */
  protected randomiseArmorModDurability(
    armor: Item[],
    itemDbDetails: ITemplateItem
  ): void;
  /**
   ...
   */
  protected presetModItemWillBeRemoved(
    weaponMod: Item,
   ...
   */
  protected randomiseItemUpdProperties(
   ...
   */
  protected initItemLimitCounter(limits: Record<string, number>): Record<
    string,
    {
      current: number;
      max: number;
