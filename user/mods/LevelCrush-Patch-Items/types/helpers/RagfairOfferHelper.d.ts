...
export declare class RagfairOfferHelper {
   ...
   */
  protected traderOfferLockedBehindLoyaltyLevel(
    offer: IRagfairOffer,
    pmcProfile: IPmcData
  ): boolean;
  /**
   ...
   */
  protected getLoyaltyLockedOffers(
   ...
   */
  protected getLocalisedOfferSoldMessage(
    itemTpl: string,
    boughtAmount: number
  ): string;
  /**
  ...
  isDisplayableOfferThatNeedsItem(
    searchRequest: ISearchRequestData,
    offer: IRagfairOffer
  ): boolean;
  /**
