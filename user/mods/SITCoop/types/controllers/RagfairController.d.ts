...
import {
  IAddOfferRequestData,
  Requirement,
} from "@spt-aki/models/eft/ragfair/IAddOfferRequestData";
...
export declare class RagfairController {
   ...
   */
  protected setTraderOfferPurchaseLimits(
    offer: IRagfairOffer,
   ...
   */
  protected isValidPlayerOfferRequest(
    offerRequest: IAddOfferRequestData,
    errorMessage: string
  ): boolean;
  /**
   ...
   */
  protected calculateRequirementsPriceInRub(
   ...
   */
  removeOffer(
    removeRequest: IRemoveOfferRequestData,
    sessionId: string
  ): IItemEventRouterResponse;
  /**
   ...
   */
  extendOffer(
    extendRequest: IExtendOfferRequestData,
    sessionId: string
  ): IItemEventRouterResponse;
  /**
   ...
   */
  protected createBuyTradeRequestObject(
    currency: string,
    value: number
