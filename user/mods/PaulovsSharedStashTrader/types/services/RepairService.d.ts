...
import {
  BonusSettings,
  IRepairConfig,
} from "@spt-aki/models/spt/config/IRepairConfig";
...
export declare class RepairService {
   ...
   */
  protected getBonusMultiplierValue(
   ...
   */
  protected shouldRepairKitApplyDurabilityLoss(
    pmcData: IPmcData,
   ...
   */
  protected addMaxResourceToKitIfMissing(
    repairKitDetails: ITemplateItem,
    repairKitInInventory: Item
  ): void;
  /**
   ...
   */
  protected getDurabilityMultiplier(
    receiveDurabilityMaxPercent: number,
    receiveDurabilityPercent: number
  ): number;
}
