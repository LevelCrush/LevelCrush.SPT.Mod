...
export declare class InsuranceService {
   ...
   */
  protected getInsuranceReturnTimestamp(
    pmcData: IPmcData,
    trader: ITraderBase
  ): number;
  /**
   ...
   */
  storeGearLostInRaidToSendLater(
    sessionID: string,
    equipmentPkg: IInsuranceEquipmentPkg[]
  ): void;
  /**
   ...
   */
  protected updateSlotIdValue(
    playerBaseInventoryEquipmentId: string,
    itemToReturn: Item
  ): void;
  /**
   ...
   * @returns True if exists
   */
  protected insuranceTraderArrayExists(
    sessionId: string,
    traderId: string
  ): boolean;
  /**
