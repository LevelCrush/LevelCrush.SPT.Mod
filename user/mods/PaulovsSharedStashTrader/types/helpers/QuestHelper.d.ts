...
export declare class QuestHelper {
   ...
   */
  doesPlayerLevelFulfilCondition(
    playerLevel: number,
   ...
   */
  traderLoyaltyLevelRequirementCheck(
    questProperties: IQuestCondition,
    profile: IPmcData
  ): boolean;
  /**
   ...
   */
  traderStandingRequirementCheck(
    questProperties: IQuestCondition,
    profile: IPmcData
  ): boolean;
  protected compareAvailableForValues(
    current: number,
    required: number,
   ...
   */
  protected generateArmorRewardChildSlots(
    originalRewardRootItem: Item,
    questReward: IQuestReward
  ): void;
  /**
   ...
   */
  getNewlyAccessibleQuestsWhenStartingQuest(
   ...
   */
  protected getQuestsWithOnlyLevelRequirementStartCondition(
    quests: IQuest[]
  ): IQuest[];
  /**
  ...
  findAndRemoveQuestFromArrayIfExists(
    questId: string,
    quests: IQuestStatus[]
  ): void;
  /**
