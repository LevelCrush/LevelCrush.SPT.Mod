...
export class PaulovsCustomTraders implements IPreAkiLoadMod, IPostDBLoadMod
{
        ...
        container.afterResolution("TraderController", (_t, result: TraderController) => 
        {
            result.getAssort = (sessionId: string, traderId: string) => {
                ...
                if (traderId === "sharedStashTrader") {
                    ...
                    PaulovsCustomTraders.traders[0].createAssort(this.databaseServer.getTables());
    ...
    buyFromTrader(pmcData: IPmcData, request: IProcessBaseTradeRequestData, sessionID: string): boolean {
        ...
        const traderDbPath = path.join( process.cwd(), "user", "cache", "PaulovsSharedStashTrader", traderId);
    ...
    sellToTrader(pmcData: IPmcData, request: IProcessBaseTradeRequestData, sessionID: string): boolean {
