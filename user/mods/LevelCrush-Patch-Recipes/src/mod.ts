...
class LC_Patch_Recipes implements IPreAkiLoadMod, IPostDBLoadMod {
  private mod: string;
  private logger: ILogger;
  private modPath: string;

  constructor() {
    this.mod = "LevelCrush-Patch-Recipes"; // Set name of mod so we can log it to console later
  }
...
module.exports = { mod: new LC_Patch_Recipes() };
