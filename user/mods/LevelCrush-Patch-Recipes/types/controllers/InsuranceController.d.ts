...
export declare class InsuranceController {
   ...
   * @returns void
   */
  protected removeInsurancePackageFromProfile(
    sessionID: string,
   ...
   * @returns void
   */
  protected processAttachmentByParent(
    attachments: Item[],
    traderId: string,
    toDelete: Set<string>
  ): void;
   ...
   */
  cost(
    request: IGetInsuranceCostRequestData,
    sessionID: string
