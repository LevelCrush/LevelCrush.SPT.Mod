...
export declare class InventoryHelper {
   ...
   */
  protected setFindInRaidStatusForItem(
   ...
   * @param output OPTIONAL - IItemEventRouterResponse
   */
  removeItemAndChildrenFromMailRewards(
    sessionId: string,
   ...
   */
  protected getBlankContainerMap(
    containerH: number,
    containerY: number
  ): number[][];
  /**
  ...
  protected getInventoryItemHash(
    inventoryItem: Item[]
  ): InventoryHelper.InventoryItemHash;
  /**
   ...
   */
  protected updateFastPanelBinding(
    pmcData: IPmcData,
    itemBeingMoved: Item
  ): void;
  /**
