...
export interface IEliminationAvailableForProps
  extends IAvailableForPropsCounter {
...
export interface IExplorationAvailableForProps
  extends IAvailableForPropsCounter {
...
export interface IExplorationCondition extends ICondition {
  _props:
    ...
    | IExitStatusConditionProps
    | IExitNameConditionProps;
}
