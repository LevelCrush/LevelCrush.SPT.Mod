...
export declare class QuestController {
   ...
   */
  protected playerLevelFulfillsQuestRequirement(
    quest: IQuest,
    playerLevel: number
  ): boolean;
  /**
   ...
   */
  protected getQuestsFailedByCompletingQuest(
   ...
   */
  protected removeQuestFromScavProfile(
    sessionId: string,
   ...
   */
  protected addTimeLockedQuestsToProfile(
    pmcData: IPmcData,
    quests: IQuest[],
    completedQuestId: string
  ): void;
