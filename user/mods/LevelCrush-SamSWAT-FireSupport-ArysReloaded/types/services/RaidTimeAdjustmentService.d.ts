...
} from "@spt-aki/models/eft/game/IGetRaidTimeResponse";
import {
  ILocationConfig,
...
export declare class RaidTimeAdjustmentService {
   ...
   */
  protected adjustLootMultipliers(
    mapLootMultiplers: LootMultiplier,
    loosePercent: number
  ): void;
  /**
