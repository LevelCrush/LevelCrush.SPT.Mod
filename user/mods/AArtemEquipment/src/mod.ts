...
class Mod implements IPostDBLoadMod
{
    ...
    postDBLoad(container: DependencyContainer): void 
    {
        ...
        db.templates.items["55d7217a4bdc2d86028b456d"]._props.Slots[6]._props.filters[0].Filter.push("ARTEM_TACTICALVEST2");
        db.templates.items["55d7217a4bdc2d86028b456d"]._props.Slots[6]._props.filters[0].Filter.push("ARTEM_TACTICALVEST3");
        db.templates.items["55d7217a4bdc2d86028b456d"]._props.Slots[6]._props.filters[0].Filter.push("ARTEM_TACTICALVEST4");
