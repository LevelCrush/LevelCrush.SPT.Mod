...
class MFACitems implements IPostDBLoadMod
{
    ...
    public postDBLoad(container: DependencyContainer): void
    {
        ...
        //Mod Info
        const modFolderName =   "Guns_YetAnotherPort_Miralyn";
        const modFullName =     "Guns_YetAnotherPort_Miralyn";
        ...
        {
            if (dbMastering[weapon].Name == "AK74") dbMastering[weapon].Templates.push("MIRA_weapon_izhmash_rpk74n_545x39");
            if (dbMastering[weapon].Name == "M4") dbMastering[weapon].Templates.push("MIRA_weapon_colt_m16a4_556x45");
            if (dbMastering[weapon].Name == "SVD") dbMastering[weapon].Templates.push("MIRA_weapon_izhmash_svd_762x54");
            if (dbMastering[weapon].Name == "AKM") dbMastering[weapon].Templates.push("MIRA_weapon_izhmash_akm_762x39_gold","MIRA_weapon_izhmash_akmn_762x39_gold","MIRA_weapon_izhmash_akms_762x39_gold","MIRA_weapon_izhmash_akmsn_762x39_gold","MIRA_weapon_izhmash_ak_762x39","MIRA_weapon_izhmash_ak_762x39_nodove");
        }
