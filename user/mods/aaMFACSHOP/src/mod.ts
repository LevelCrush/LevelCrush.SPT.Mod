...
class aaMFACSHOP implements IPreAkiLoadMod, IPostDBLoadMod {
  ...
  public postDBLoad(container: DependencyContainer): void {
    ...
    const traderConfig: ITraderConfig = configServer.getConfig(
      ConfigTypes.TRADER
    );
  ...
  private addTraderToDb(
    ...
    tables.traders[traderDetailsToAdd._id] = {
      assort: jsonUtil.deserialize(
        jsonUtil.serialize(assortJson)
      ) as ITraderAssort, // assorts are the 'offers' trader sells, can be a single item (e.g. carton of milk) or multiple items as a collection (e.g. a gun)
