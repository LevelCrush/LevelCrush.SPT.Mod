...
export declare class ProfileFixerService {
  ...
  protected addMissingHallOfFameContainerImprovements(
    pmcProfile: IPmcData
  ): void;
  ...
  protected getActiveRepeatableQuests(
   ...
   */
  protected removeResourcesFromSlotsInHideoutWithoutLocationIndexValue(
    pmcProfile: IPmcData
  ): void;
  /**
   ...
   */
  protected getBonusFromProfile(
    profileBonuses: Bonus[],
    bonus: StageBonus
  ): Bonus;
  /**
