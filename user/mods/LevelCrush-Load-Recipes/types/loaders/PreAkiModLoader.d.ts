...
export declare class PreAkiModLoader implements IModLoader {
   ...
   */
  protected checkForDuplicateMods(
  ...
  protected autoInstallDependencies(
    modPath: string,
    pkg: IPackageJsonData
  ): void;
  protected areModDependenciesFulfilled(
    pkg: IPackageJsonData,
    loadedMods: Map<string, IPackageJsonData>
  ): boolean;
  protected isModCompatible(
    mod: IPackageJsonData,
    loadedMods: Map<string, IPackageJsonData>
  ): boolean;
  /**
