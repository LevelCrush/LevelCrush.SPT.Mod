...
export declare class ScavCaseRewardGenerator {
   ...
   * @returns Product array
   */
  protected randomiseContainerItemRewards(
   ...
   */
  protected getScavCaseRewardCountsAndPrices(
    scavCaseDetails: IHideoutScavCase
  ): ScavCaseRewardCountsAndPrices;
  /**
   ...
   */
  protected getRandomAmountRewardForScavCase(
    itemToCalculate: ITemplateItem,
    rarity: string
  ): number;
}
